...
Loop2:	srl  $t5,$t5,1 # $t5=$t5*2
	sw   $t5,0x800 # write to PORT_LEDR[7-0]
	sw   $t5,0x804 # write to PORT_HEX0[7-0]
	sw   $t5,0x805 # write to PORT_HEX1[7-0]
	sw   $t5,0x808 # write to PORT_HEX2[7-0]
	sw   $t5,0x809 # write to PORT_HEX3[7-0]
	sw   $t5,0x80C # write to PORT_HEX4[7-0]
	sw   $t5,0x80D # write to PORT_HEX5[7-0]
	#j    delay
